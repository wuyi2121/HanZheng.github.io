...
Welcome to follow [CSDN](https://blog.csdn.net/weixin_65089713?type=blog) / [Bilibili](https://space.bilibili.com/1353527764?spm_id_from=333.1007.0.0) / [Github](https://github.com/wuyi2121)
...
<div class='paper-box'><div class='paper-box-image'><div><img src='images/ICV.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><img src='images/ITSC.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
- I participated in the ITSC 2022 Autonomous Parking Trajectory Planning International Challenge as an independent team member in the first semester of his sophomore year, innovated an efficient and safe collision detection algorithm to cope with confined spaces, and wrote his first academic paper in English in the second semester of his sophomore year, and submitted the algorithm summary to a paper..
...
- A future-oriented air-ground cooperative unmanned grazing system was designed on the basis of the National Innovation Project, which utilizes an all-terrain mobile charging platform of wheel-legged structure to cooperate with a cluster of UAVs for fully automated grazing, and I am mainly responsible for the modeling of the mechanical structure and the design of the conceptual video frame.
</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><img src='images/biandui.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
